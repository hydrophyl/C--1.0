...
int main()
{
	...
	int howmuch;
	cout << "Wie oft? Einmalig Ausfuehrung [1], bestimmte Anzahl [n != 3] eingeben, unendlich bis mittelwert gut [3]: ";
	cin >> howmuch;
	...
	// n Mals als default
		...
		case 3:
		{
			cout << "Programm wird wiederholt, bis Mittelwert gewunschte Genauigkeit erreicht!" << endl;
			signed int nkmstllen;
			cout << "Anzahl der gewunschten Nachkommastellen: ";
			cin >> nkmstllen;
			if (nkmstllen < 0){
				cout << "Es muss groesser als 0 sein!" << endl << "Nachkommastellen: ";
				cin >> nkmstllen;
			}
			//Radius
			double r;
